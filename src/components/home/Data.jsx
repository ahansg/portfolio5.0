  ...
  return (
    <div className="home__data">
      ...
      <p className="body_text">
        Jeg er en interaksjonsdesigner som er opptatt av å forbedre livene til
        andre gjennom god design. Fra tidligere er jeg utdannet sykepleier og
        tar med meg erfaringen om mennesker først inn i brukeropplevelsen.
      </p>
    </div>
  );
};
